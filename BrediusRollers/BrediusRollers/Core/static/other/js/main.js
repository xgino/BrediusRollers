    ...
    $(document).ready(function () {
        ...
        if ($('#player-radar-graph').length > 0) {
            ...
            $('#player-radar-graph').teamRadarGraph(
                    'stats',
                    ["Defending", "Shooting", "Posession", "Position", 
                    "Passing", "Control", "Speed", "Technical"],

                    // Player Graph
                    // defending, shooting, posession, position, passing, control, Speed, Technical
                    [60, 70, 65, 65, 70, 60, 55, 80],
                    350,
                    350

                    // Team Graph
                    // Attacking, defending, posession, position, pace, Vision, Passing
                    );
